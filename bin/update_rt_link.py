...
def main():
    argparse = ArgumentParser(description='Update the RT link of a submission in the submission webservice')
    ...
    argparse.add_argument('--rt_link', required=True, type=str, help='URL for RT ticket')
